...
The current OpenShare release is **0.2.40**. The canonical value lives in [`VERSION`](VERSION), is
...
`OPENSHARE_VERSION=0.2.40` to pin this release, or use the published `sha-<commit>` tag for an
